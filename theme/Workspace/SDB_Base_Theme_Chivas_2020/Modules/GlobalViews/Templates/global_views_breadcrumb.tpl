...
<ul class="global-views-breadcrumb-container" itemprop="breadcrumb">
    ...
    <li class="global-views-breadcrumb-item">
        <a href="{{href}}" {{#if hasDataTouchpoint}} data-touchpoint="{{data-touchpoint}}" {{/if}} {{#if hasDataHashtag}} data-hashtag="{{data-hashtag}}" {{/if}}> {{text}} </a>
    </li>
...
{{!---- Use the following context variables when customizing this template: pages (Array) ----}}